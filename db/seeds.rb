User.create!([
  {email: "test@test.com", username: "anonymous tester", encrypted_password: "$2a$10$DI9BN9Sz4wGtNEMrN0.n3OBixLtUGl21yNqatt37fLDxYXSBdPBxG", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 2, current_sign_in_at: "2016-06-08 17:05:02", last_sign_in_at: "2016-06-08 17:03:50", current_sign_in_ip: "::1", last_sign_in_ip: "::1"},
  {email: "jake@jake.com", username: "jake", encrypted_password: "$2a$10$JO5flToli8VWwo3bEDqNruSeu8b/9cCK6qLpT.HIKS8eNpq.v6ksC", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 3, current_sign_in_at: "2016-06-08 17:13:34", last_sign_in_at: "2016-06-08 16:40:18", current_sign_in_ip: "::1", last_sign_in_ip: "::1"},
  {email: "judy@judy.com", username: "judy", encrypted_password: "$2a$10$oIAQBz8QzipLP8wEa73FUeJks1ZLBPioUAFpPd5naU7Tk1jXocthG", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 2, current_sign_in_at: "2016-06-08 17:15:09", last_sign_in_at: "2016-06-08 16:40:29", current_sign_in_ip: "::1", last_sign_in_ip: "::1"}
])
Comment.create!([
